...
contig_number_input=$(cat ${log_file} | awk 'NR == 25 {print $2}')
contig_length_input=$(cat ${log_file} | awk 'NR == 26 {print $2}')
N50_input=$(cat ${log_file} | awk 'NR == 27 {print $2}')
contig_number_iteration1=$(cat ${log_file} | awk 'NR == 30 {print $2}')
contig_length_iteration1=$(cat ${log_file} | awk 'NR == 31 {print $2}')
N50_iteration1=$(cat ${log_file} | awk 'NR == 32 {print $2}')
contig_number_iteration2="NA"
contig_length_iteration2="NA"
N50_iteration2="NA"
contig_number_FinalIteration=$(cat ${log_file} | awk 'NR == 35 {print $2}')
contig_length_FinalIteration=$(cat ${log_file} | awk 'NR == 36 {print $2}')
N50_FinalIteration=$(cat ${log_file} | awk 'NR == 37 {print $2}')
